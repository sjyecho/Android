...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    final String CREATE_COLLECTIONS_SQL = "create table collections(_id integer primary key autoincrement,name,phone)";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL(CREATE_COLLECTIONS_SQL);
    }
